                ...
                <tbody>
                    @foreach($products as $key => $product)
                        <tr data-entry-id="{{ $product->id }}">
                            ...
                            <td>
                                <img src="{{ URL::to ('images/'.$product->image) }}" style="width:70px">
                            </td>
                            <td>
                                @can('product_show')
                                ...
                                @endcan
                                @can('product_delete')
                                    <form action="{{ route('admin.products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.notif') }}');" style="display: inline-block;">
